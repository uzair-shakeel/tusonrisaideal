      ...
      <div className="bg-[#263238] w-full px-3 mt-0 ">
        <div className="max-w-[1440px] w-full mx-auto py-[20px] md:py-[57px] md:px-12 flex lg:items-center items-start lg:flex-row flex-col justify-between gap-6 md:gap-14">
          <div>
            <Image
              ...
              height={43}
            />
            <h3 className="text-[#F4F4F4] text-base font-normal py-5">
              The trusted place for all your healthcare needs.
            </h3>
            <div className="flex items-center gap-2">
              <Link href="/">
                <Image
                  src="/assets/call-logo.svg"
                  alt="Call Logo"
                  width={62}
                  height={62}
                />
          ...
          <div className="w-full grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4">
            <div className="text-[#F4F4F4]">
              <h3 className="text-base sm:text-lg font-medium uppercase pb-1.5 md:pb-5">
                SERVICES
              </h3>
              <ul>
                <li>
        ...
        <div className="max-w-[730px] mx-auto w-full pb-[20px] md:pb-[42px] text-[#F4F4F4]">
          ...
          <p className="text-xs font-normal mb-3">
            Get expert advice and updates on the latest health tips and services
          ...
          <div className="bg-[#F6F6F6] rounded-[28px] flex justify-between max-w-[547px] h-[47px]">
            <input
              ...
              placeholder="Email"
              required
              className="bg-transparent p-4 outline-none text-black w-full"
            />
            <button className="bg-[#FEF14B] min-w-[121px] h-[31px] my-auto text-[#263238] text-sm font-bold mr-3 rounded-[10px]">
              Subscribe
            </button>
          </div>
          <p className="text-[10px] leading-[24px] font-normal py-1.5">
            By subscribing, you agree to our Privacy Policy and Terms of
            Service. This site is protected by reCAPTCHA and the Google Privacy
