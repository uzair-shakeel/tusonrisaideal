...
const reviews = [
  {
    ...
    review:
      "Amazing dental experience! The staff was professional and friendly, and the clinic was spotless. I felt well taken care of and would highly recommend this place to anyone.",
  },
  {
    name: "Alejandro López",
    image: "/assets/rating1.svg",
    review:
      "I received excellent dental care during my visit. The dentist was thorough and explained everything clearly. The environment was very welcoming, and I felt at ease throughout my treatment.",
  ...
  },
  {
    ...
    image: "/assets/rating1.svg",
    review:
      "The dental clinic provided top-notch service from start to finish. The appointments were prompt, and the staff was extremely helpful and courteous. I am very satisfied with the results.",
  },
  {
    name: "María Rodríguez",
    image: "/assets/rating1.svg",
    review:
      "Highly recommend this dental clinic! The facilities are state-of-the-art, and the medical team is knowledgeable and attentive. My treatment plan was tailored to my needs, and I could not be happier with the outcome.",
  },
  {
    name: "María Rodríguez",
    image: "/assets/rating1.svg",
    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <div className="md:hidden flex items-end justify-end">
          <button
            className="text-[14px] leading-[14.45px] font-bold w-[155px] h-[41px] rounded-[10px] bg-[#FEF14B]"
            onClick={togglePopup}
          >
            Escribir la Reseña
          </button>
        ...
        <div className="flex justify-between  mdl:flex-col flex-row">
          ...
          <div className="flex flex-col gap-2.5 w-[60%] md:w-full">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[#263238] text-[12px] leading-[19px] font-normal">
                19
              </h3>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex mdl:mt-[110px] flex-col">
          ...
          <div className="flex mt-[20px]">
            <div className="mdl:w-[140px] mdl:h-[135px] sm:pr-[25px] sm:border-r border-[#E8E8E8]">
              ...
              <p className="text-[#263238] text-[16px] leading-[19px] font-normal pt-[10px]">
                Doctor’s treatment
              </p>
            </div>
      ...
      <div className="max-w-[927px]">
        <div className="max-w-[927px] grid md:grid-cols-2 grid-cols-1 gap-[30px]">
          {displayedReviews.map((review, index) => (
            <div
              key={index}
              className="bg-white shadow-custom rounded-[10px] p-4"
            >
              <div className="flex items-center gap-2.5">
                <Image src={review.image} alt="User" width={64} height={64} />
                <div>
                  <h3 className="text-[#263238] text-[18px] leading-[19px] font-medium mb-2">
                    {review.name}
                  </h3>
              ...
              <p className="mt-[18px] text-[#263238] text-[14px] leading-[19px] font-normal">
                {review.review}
              </p>
            </div>
          ))}
