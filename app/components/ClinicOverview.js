      ...
      <div className="max-w-[1369px] w-full mx-auto flex justify-between gap-4">
        <div className="max-w-[945px] w-full">
          <div className="max-w-[845px] lg:pl-2">
            <div className="flex justify-between md:justify-normal items-center sm:gap-7 gap-3">
              <h3 className="text-[#797E81] text-[13px] md:text-[16px] leading-[19px] font-normal flex items-center gap-1">
              ...
              <h3 className="text-[#797E81] text-[16px] leading-[19px] font-normal hidden md:flex items-center gap-1">
                <Image
                  src="/assets/sun.svg"
                  alt="Logo"
                  width={20}
            ...
            <h3 className="text-[#181515] text-[22px] leading-[19px] font-semibold py-4">
              Clinic Overview
            </h3>
            ...
            <div>
              ...
              {showMore && (
                <p className="text-[#263238] text-[16px] leading-[19px] font-normal mt-2.5">
                  Centro de Salud El Sol es un hospital líder en atención
                  médica, comprometido con ofrecer servicios de salud de alta
                  calidad a la comunidad. Ubicado en el corazón de Ciudad del
                  Sol, nuestro centro se dedica a proporcionar atención médica
                  integral y personalizada en un entorno acogedor y moderno.
                </p>
              )}
              <button
          ...
          <div className="max-w-[945px] w-full border-b border-[#D0D0D0] py-2.5">
            <div className="flex items-center justify-between gap-4 max-w-[820px] flex-wrap pl-2">
              <div className="flex items-start gap-2">
                <Image
                  src="/assets/trabaja-con-aseguradoras.svg"
                  alt="Logo"
                  width={16}
                  height={14.22}
                  className="mt-0.5 min-w-[16px] min-h-[14.22px]"
                />
                <div className="inter-font text-[#000000]">
                  <h3 className="text-[13.5px] leading-[20px] font-bold">
              ...
              <div className="flex items-start gap-2">
                <Image
                  src="/assets/gabinetes.svg"
                  alt="Logo"
                  width={18}
                  height={16}
                  className="mt-0.5 min-w-[18px] min-h-[16px]"
                />
                <div className="inter-font text-[#000000]">
                  <h3 className="text-[13.5px] leading-[20px] font-bold">
                    Gabinetes
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="inter-font text-[#000000]">
                  ...
                  <span className="text-[12.6px] leading-[20px]">
          ...
          <div id="location" className="pt-[40px]">
            <h3 className="text-[#181515] text-[22px] leading-[19px] font-semibold mb-4">
              Explore the area
            </h3>
            <p className="text-[#263238] text-[16px] leading-[19px] font-normal mb-4">
              Avenida Principal 123, Ciudad del Sol, Estado del Sol, 45678
            </p>
