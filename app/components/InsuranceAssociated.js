...
const InsuranceItem = ({ src, alt, name }) => (
  <div className="flex items-center gap-3">
    ...
    <h2 className="text-[#263238] text-[18px] leading-[19px] font-medium">
      {name}
    </h2>
  </div>
);
...
const InsuranceAssociated = () => {
  ...
  return (
    <div className="max-w-[1360px] w-full lg:ml-[40px] p-1 pt-[60px] md:py-[70px] ">
      {/* Insurance Associated */}
      <h2 className="text-[#181515] text-[22px] leading-[19px] font-semibold">
        Insurance Associated
      </h2>
      <h4 className="text-[#263238] text-[16px] leading-[19px] font-normal mt-2.5">
      ...
      <div className="max-w-[937px] py-5 px-2.5 border-b border-t border-[#D0D0D0]">
        ...
        <div className="mt-1.5 flex items-center gap-6">
          <Image
            src="/assets/TSI-Awards.svg"
            alt="Logo"
            width={112}
            height={112}
          />
          <div>
            <h3 className="text-[#181515] text-[18px] leading-[19px] mb-2 font-semibold">
              Bronce Level Clinic
            </h3>
            <Link
              href="/"
            ...
            >
              Know more <FaArrowRight className="text-[14px]" />
            </Link>
          </div>
        </div>
      </div>
