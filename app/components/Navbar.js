      ...
      <div className="w-full mx-auto flex items-center max-w-[1440px] justify-between py-5 px-4 lg:px-[36px]">
        <div className="flex items-center gap-2">
          ...
          <img
            ...
            width={91.02}
            height={43}
            className="min-w-[91.02px] min-h-[43px]"
          />
        </div>
        ...
        <button className="bg-[#FEF14B] min-w-[180px] sm:min-w-[220px] min-h-[42px] rounded-[10px] text-[12px] lg:text-[14px] leading-[20px] text-[#333333] font-bold">
          Únete como Clínica/Dentista
        </button>
      </div>
      {menuOpen && (
