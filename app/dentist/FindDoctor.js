...
const FindDoctor = () => {
  ...
  return (
    <div className="px-3 w-full max-w-[929px] mb-[380px] mx-auto pl-2 lg:ml-[40px]">
              ...
              <li
                className={`text-${
                  activeTab === "specialties"
                    ? "[#2C64D8] underline underline-offset-[16px] text-[16px] leading-[24px] font-semibold"
                    : "16px] leading-[24px] text-[#6A6A6A] cursor-pointer"
                }`}
