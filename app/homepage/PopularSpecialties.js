...
const PopularSpecialties = () => {
    const [visibleSpecialties, setVisibleSpecialties] = useState(specialties.slice(0, 12));
    ...
    return (
        <>
            <div className='text-center max-w-[1440px] mx-auto w-full py-[60px] px-2 sm:px-6'>
                ...
                {showAll ? (
                    <button onClick={handleSeeLess} className='w-[157px] h-[41px] rounded-[10px] border border-[#263238] bg-white text-[#263238] text-[14px] leading-[14.45px] font-bold'>
                        See Less
                    </button>
                ) : (
                    <button onClick={handleViewAll} className='w-[157px] h-[41px] rounded-[10px] border border-[#263238] bg-white text-[#263238] text-[14px] leading-[14.45px] font-bold'>
                        View All
                    </button>
                )}
            </div>
                ...
                <div className='w-full max-w-[1440x] mx-auto py-10'>
                    <div className='flex md:flex-row flex-col items-center gap-14 md:gap-2 justify-between max-w-[1100px] mx-auto'>
                        <div className='relative'>
                            <Image src='/assets/customers.svg' alt='Image' width={450} height={300} className='relative' />
